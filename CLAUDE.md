...
- **경계선 위계**: 시도(흰 선, z3에서 굵어짐) > 시군구(z2부터) > 동(z4부터 흐린 점선).
  선이 겹쳐 보이던 문제는 단계별로 굵기·투명도를 벌려서 해결.
...
### 현재 수량 (2026-08-24)
등산 123 / 숙박 106(리조트 포함) / 카페 102 / 맛집 96 / 전시·구경 77 / 해변 76 /
캠핑 61 / 축제 54 / 스키·썰매 52 / 드라이브 50 / 계곡 49 / 쇼핑·시장 38 / 온천 35 / 공연 26
= **스팟 945곳** + 러닝 156곳 = **1,101곳**
좌표 945/945(100%), 러닝 추천 주차 156/156(100%). conf 는 high 538 / mid 405 / low 2.
- 남은 conf:low 2곳 — 서울식당(태안 게국지, 2차 출처 없음), 이천 예스파크(공방 300곳 휴무 제각각)
