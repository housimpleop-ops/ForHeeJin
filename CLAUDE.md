...
캠핑 98 / 계곡 91 / 드라이브 91 / 온천 88 / 해변 86 / 공연 82 / 스키·썰매 52
= **스팟 1,556곳** + 러닝 188곳 = **1,744곳**, 좌표 100%
...
- **예약 정보 905곳, 그중 공식 예약 URL 318곳.** 링크는 전부 눌러서 200 응답을 확인했다
  (하얏트·메리어트·반얀트리는 봇 차단으로 403이 뜨지만 브라우저에서는 정상)
...
- **온천 88곳 전부 `swimsuit`(커플이 수영복 입고 함께 들어갈 수 있는지)이 확정**됐다.
...
cat tools/_u.txt | xargs -P 16 -I{} bash tools/chk1.sh "{}" > tools/_urlchk2.txt
```
